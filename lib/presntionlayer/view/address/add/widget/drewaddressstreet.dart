...
import 'package:provider/provider.dart';
      ...
      Widget drewAddressStreet(BuildContext context){
      ...
      child:TextFormField(
        ...
        validator: (String? value) {
          if (value == null || value.isEmpty) {
            return "أدخل عنوان الشارع ";
          }
          return null;
        },
        controller:context.read<AddressProvider>().textEditingControllerTitle,
